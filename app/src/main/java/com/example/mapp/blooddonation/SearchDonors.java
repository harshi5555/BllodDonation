...
public class SearchDonors extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.mapp.blooddonation.R.layout.activity_search_donors);
        ...
        searchButton = (Button) findViewById(com.example.mapp.blooddonation.R.id.search);
        editText = (EditText) findViewById(com.example.mapp.blooddonation.R.id.adress);
    ...
    public void onClick(View v) {
        ...
        String city = "";
        try {
            Spinner spinner = (Spinner) findViewById(R.id.bloodGrpSpinner);
            bloodGroup = spinner.getSelectedItem().toString();
            city = ((TextView) findViewById(R.id.searchCity)).getText().toString();
            System.out.println("Selected blood group is >" + bloodGroup + "<" + " selected city >"+city+"<");
        ...
        if(intentIn!= null){
            ...
            intentIn.putExtra("BloodGroup",bloodGroup);
